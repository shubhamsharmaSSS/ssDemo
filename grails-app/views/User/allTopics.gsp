...
<div class="col-sm-10" style="padding-left: 5%; ">
    <div class="col-sm-12" id="allTopicsDiv" style="margin-top: 5%">
        <g:render template="/templates/commanTopicTemplate"
                  model="[user: user, topicList: allTopicList, showStatus: showStatus]"/>
    </div>
</div>
</body>
</html>